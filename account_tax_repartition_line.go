...
type AccountTaxRepartitionLine struct {
	...
	TagIdsDomain               *String    `xmlrpc:"tag_ids_domain,omptempty"`
	...
	XStudioCharFieldCaq9X      *String    `xmlrpc:"x_studio_char_field_caq9X,omptempty"`
	XStudioQstPercentage       *Float     `xmlrpc:"x_studio_qst_percentage,omptempty"`
	XStudioQstWage             *Float     `xmlrpc:"x_studio_qst_wage,omptempty"`
	XStudioWhithholdingTaxCode *Selection `xmlrpc:"x_studio_whithholding_tax_code,omptempty"`
	XStudioYear                *Selection `xmlrpc:"x_studio_year,omptempty"`
}
