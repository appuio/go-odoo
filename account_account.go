...
type AccountAccount struct {
	...
	ExcludeProvisionCurrencyIds *Relation  `xmlrpc:"exclude_provision_currency_ids,omptempty"`
	...
	MultipleAssetsPerLine       *Bool      `xmlrpc:"multiple_assets_per_line,omptempty"`
