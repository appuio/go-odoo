...
type AccountTax struct {
	...
	XCurrencyId                  *Many2One  `xmlrpc:"x_currency_id,omptempty"`
	XStudioCanton                *Selection `xmlrpc:"x_studio_canton,omptempty"`
	XStudioCharFieldN4T98        *String    `xmlrpc:"x_studio_char_field_N4t98,omptempty"`
	XStudioQstWage               *Float     `xmlrpc:"x_studio_qst_wage,omptempty"`
	XStudioQstYear               *Selection `xmlrpc:"x_studio_qst_year,omptempty"`
	XStudioRelatedField12Xwg     *Float     `xmlrpc:"x_studio_related_field_12xwg,omptempty"`
	XStudioSelectionFieldXeqhO   *Selection `xmlrpc:"x_studio_selection_field_XeqhO,omptempty"`
	XStudioWithholdingTax        *Float     `xmlrpc:"x_studio_withholding_tax_,omptempty"`
	XStudioWithholdingTextCode   *Selection `xmlrpc:"x_studio_withholding_text_code,omptempty"`
}
