...
type HrDepartureWizard struct {
	...
	ArchiveAllocation         *Bool     `xmlrpc:"archive_allocation,omptempty"`
	ArchivePrivateAddress     *Bool     `xmlrpc:"archive_private_address,omptempty"`
	CancelAppraisal           *Bool     `xmlrpc:"cancel_appraisal,omptempty"`
	CancelLeaves              *Bool     `xmlrpc:"cancel_leaves,omptempty"`
	...
	SendHrDocumentsAccessLink *Bool     `xmlrpc:"send_hr_documents_access_link,omptempty"`
	SetDateEnd                *Bool     `xmlrpc:"set_date_end,omptempty"`
