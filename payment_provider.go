...
type PaymentProvider struct {
	...
	SddSignatureRequired       *Bool      `xmlrpc:"sdd_signature_required,omptempty"`
	SddSmsCredits              *Float     `xmlrpc:"sdd_sms_credits,omptempty"`
	SddSmsVerificationRequired *Bool      `xmlrpc:"sdd_sms_verification_required,omptempty"`
...
func (c *Client) CreatePaymentProviders(pps []*PaymentProvider) ([]int64, error) {
	...
	return c.Create(PaymentProviderModel, vv)
}
