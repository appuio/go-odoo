...
type StockReplenishmentInfo struct {
	...
	SupplierinfoId           *Many2One `xmlrpc:"supplierinfo_id,omptempty"`
	SupplierinfoIds          *Relation `xmlrpc:"supplierinfo_ids,omptempty"`
...
func (c *Client) CreateStockReplenishmentInfos(sris []*StockReplenishmentInfo) ([]int64, error) {
	...
	return c.Create(StockReplenishmentInfoModel, vv)
}
