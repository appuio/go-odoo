...
type HrDepartment struct {
	...
	AppraisalsToProcessCount    *Int      `xmlrpc:"appraisals_to_process_count,omptempty"`
	...
	CustomAppraisalTemplates    *Bool     `xmlrpc:"custom_appraisal_templates,omptempty"`
	...
	PlanIds                     *Relation `xmlrpc:"plan_ids,omptempty"`
	PlansCount                  *Int      `xmlrpc:"plans_count,omptempty"`
