...
type AccountReport struct {
	...
	CustomHandlerModelId     *Many2One  `xmlrpc:"custom_handler_model_id,omptempty"`
	CustomHandlerModelName   *String    `xmlrpc:"custom_handler_model_name,omptempty"`
	...
	FilterAnalyticGroupby    *Bool      `xmlrpc:"filter_analytic_groupby,omptempty"`
	...
	FootnotesTemplate        *String    `xmlrpc:"footnotes_template,omptempty"`
	HorizontalGroupIds       *Relation  `xmlrpc:"horizontal_group_ids,omptempty"`
	Id                       *Int       `xmlrpc:"id,omptempty"`
	LineIds                  *Relation  `xmlrpc:"line_ids,omptempty"`
	LineTemplate             *String    `xmlrpc:"line_template,omptempty"`
	LoadMoreLimit            *Int       `xmlrpc:"load_more_limit,omptempty"`
	MainTableHeaderTemplate  *String    `xmlrpc:"main_table_header_template,omptempty"`
	MainTemplate             *String    `xmlrpc:"main_template,omptempty"`
	...
	SearchTemplate           *String    `xmlrpc:"search_template,omptempty"`
