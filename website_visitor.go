...
type WebsiteVisitor struct {
	...
	EventRegisteredIds     *Relation  `xmlrpc:"event_registered_ids,omptempty"`
	EventRegistrationCount *Int       `xmlrpc:"event_registration_count,omptempty"`
	EventRegistrationIds   *Relation  `xmlrpc:"event_registration_ids,omptempty"`
	HasPushNotifications   *Bool      `xmlrpc:"has_push_notifications,omptempty"`
	...
	PushSubscriptionIds    *Relation  `xmlrpc:"push_subscription_ids,omptempty"`
	...
	VisitorProductCount    *Int       `xmlrpc:"visitor_product_count,omptempty"`
