...
type MailComposeMessage struct {
	...
	CanAttachAttachment  *Bool      `xmlrpc:"can_attach_attachment,omptempty"`
	...
	DraftCount           *Int       `xmlrpc:"draft_count,omptempty"`
	...
	ForwardRef           *String    `xmlrpc:"forward_ref,omptempty"`
	...
	MarketingActivityId  *Many2One  `xmlrpc:"marketing_activity_id,omptempty"`
	...
	ObjectAttachmentIds  *Relation  `xmlrpc:"object_attachment_ids,omptempty"`
	...
	WizardMode           *Selection `xmlrpc:"wizard_mode,omptempty"`
