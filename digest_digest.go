...
type DigestDigest struct {
	...
	KpiLivechatConversations           *Bool      `xmlrpc:"kpi_livechat_conversations,omptempty"`
	KpiLivechatConversationsValue      *Int       `xmlrpc:"kpi_livechat_conversations_value,omptempty"`
	KpiLivechatRating                  *Bool      `xmlrpc:"kpi_livechat_rating,omptempty"`
	KpiLivechatRatingValue             *Float     `xmlrpc:"kpi_livechat_rating_value,omptempty"`
	KpiLivechatResponse                *Bool      `xmlrpc:"kpi_livechat_response,omptempty"`
	KpiLivechatResponseValue           *Float     `xmlrpc:"kpi_livechat_response_value,omptempty"`
	...
	KpiWebsiteSaleTotal                *Bool      `xmlrpc:"kpi_website_sale_total,omptempty"`
	KpiWebsiteSaleTotalValue           *Float     `xmlrpc:"kpi_website_sale_total_value,omptempty"`
