...
type HrExpenseSheet struct {
	...
	ApprovalDate                *Time      `xmlrpc:"approval_date,omptempty"`
	...
	ExpenseNumber               *Int       `xmlrpc:"expense_number,omptempty"`
	...
	JournalDisplayedId          *Many2One  `xmlrpc:"journal_displayed_id,omptempty"`
