...
type AccountJournal struct {
	...
	AccountOnlineAccountId        *Many2One  `xmlrpc:"account_online_account_id,omptempty"`
	AccountOnlineLinkId           *Many2One  `xmlrpc:"account_online_link_id,omptempty"`
	AccountOnlineLinkState        *Selection `xmlrpc:"account_online_link_state,omptempty"`
	...
	ExpiringSynchronizationDueDay *Int       `xmlrpc:"expiring_synchronization_due_day,omptempty"`
	FailedMessageIds              *Relation  `xmlrpc:"failed_message_ids,omptempty"`
	HasMessage                    *Bool      `xmlrpc:"has_message,omptempty"`
	HasSepaCtPaymentMethod        *Bool      `xmlrpc:"has_sepa_ct_payment_method,omptempty"`
	...
	NextLinkSynchronization       *Time      `xmlrpc:"next_link_synchronization,omptempty"`
