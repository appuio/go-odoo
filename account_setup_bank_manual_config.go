...
type AccountSetupBankManualConfig struct {
	...
	L10NChIsrSubscriptionChf    *String    `xmlrpc:"l10n_ch_isr_subscription_chf,omptempty"`
	L10NChIsrSubscriptionEur    *String    `xmlrpc:"l10n_ch_isr_subscription_eur,omptempty"`
	L10NChPostal                *String    `xmlrpc:"l10n_ch_postal,omptempty"`
	L10NChQrIban                *String    `xmlrpc:"l10n_ch_qr_iban,omptempty"`
	L10NChShowSubscription      *Bool      `xmlrpc:"l10n_ch_show_subscription,omptempty"`
