...
type WebsitePage struct {
	...
	FooterVisible             *Bool      `xmlrpc:"footer_visible,omptempty"`
	...
	HeaderVisible             *Bool      `xmlrpc:"header_visible,omptempty"`
	...
	IsInMenu                  *Bool      `xmlrpc:"is_in_menu,omptempty"`
	...
	VisibilityPassword        *String    `xmlrpc:"visibility_password,omptempty"`
	VisibilityPasswordDisplay *String    `xmlrpc:"visibility_password_display,omptempty"`
